...
(function () {
  ...
  _.extend(FreeCell.prototype, {
    ...
    deal: function (seed) {
      ...
      this.columns.forEach(function (column) { column.render(); });
    },
    ...
    getColumn: function (i) { return this.columns[i]; },
    getCell: function (i) { return this.cells[i]; },
    getFoundation: function (i) { return this.foundations[i]; }
  });
