...
function UtilLibrary() {
  ...
  mixin(Panel, mixInStyleProps({x: 0, y: 0, z: 0, zIndex: 0, width: null, height: null}, true));
  mixin(Panel, mixInPanelProps({draggable: true, droppable: true, visible: true, html: false, text: "", hittest: false, parentPanel: null, cssClasses: []}, true));
  ...
  mixin(PanelCollection, mixInStyleProps({x: 0, y: 0, z: 0, zIndex: 0, width: null, height: null}, true));
  mixin(PanelCollection, mixInPanelProps({draggable: true, droppable: true, visible: true, html: false, text: "", hittest: false, parentPanel: null, cssClasses: []}, true));
